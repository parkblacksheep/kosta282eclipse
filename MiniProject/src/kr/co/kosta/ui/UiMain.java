...
/*
	...
	요구사항
		...
		리누스 토발즈	20240628		국어교육학과	국어		100		88
		제임스 고슬링	202470629	국어교육학과	국어		89 			94
		이도			202470629	컴퓨터공학		수학		83			56
		...
		리누스 토발즈	20240628		국어		100		S
		제임스 고슬링	202470629	국어		89 			B
		이도			202470630	수학		83			B
		------------------------------------------
		수학과목 학점 결과 >>> 
		===========================================
		이름 			학번 			필수		수학점수  학점
		...
		리누스 토발즈	20240628		국어		88			B
		제임스 고슬링	202470629	국어		94			A
		이도			202470630	수학		56			F
		------------------------------------------
		...
		5.유지보수(업그레이드)
			1) 과목과 학점 저액 추가 
				...
				-전체 5명 학생중 3명만 이 과목에 수강신청했습니다.
			2) 학점 결과를 아래와 같이 나올 수 있도록 구현 하시오.
		...
		리누스 토발즈	20240628		국어		55			f
		------------------------------------------
			
		*Builder Pattern
		 	1) 메서드의 조합으로 결과물을 생성하는 방법
		 		-생성에 대한 과정과 각 결과물을 표현하는 방법을 분리하여 
		 			동일한 생성 과정에 서로 다른 여러 결과물이 나올 수 있도록 함
	 			-클라이언트 코드는 Builder가 제공하는 메서드를 
	 				기반으로 원하는 결과물을 얻을 수 있도록 함
*/
...
public class UiMain {
	...
	private void createStudent() {
		Student student1 = new Student("스티브 잡스", 20240626, korean);
		Student student2 = new Student("이순신", 20240627, math);
		Student student3 = new Student("리누스 토발즈", 20240628, korean);
		Student student4 = new Student("제임스 고슬링", 20240629, korean);
		Student student5 = new Student("이도", 202470630, math);
